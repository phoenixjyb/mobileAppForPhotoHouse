...
assert re.search(r'OK \(22 tests\)', text), 'Instrumentation did not pass all twenty-two tests'
PY
...
printf 'PASS 22 emulator component UI tests; font scale %s; synthetic own-View renders retained.\n' "$scale"
