...
assert re.search(r'OK \(4 tests\)', text), 'Instrumentation did not pass all four tests'
PY
for name in unconfigured-en unconfigured-zh admission-en literal-caption-en literal-caption-zh photo-navigation-en photo-navigation-zh; do
...
printf 'PASS 4 emulator component UI tests; font scale %s; synthetic own-View renders retained.\n' "$scale"
