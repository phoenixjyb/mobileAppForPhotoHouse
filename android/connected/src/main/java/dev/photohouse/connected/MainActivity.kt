    ...
    private val model by viewModels<ConnectedViewModel> {
        object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                ...
                return ConnectedViewModel(origin?.let { HttpsPhotoHouseApi(it, protectedNativeV2Enabled = BuildConfig.PHOTOHOUSE_PROTECTED_NATIVE_V2_ENABLED, discoveryEnabled = BuildConfig.PHOTOHOUSE_DISCOVERY_ENABLED, photoDeliveryEnabled = BuildConfig.PHOTOHOUSE_PHOTO_DELIVERY_ENABLED) }) as T
            }
        }
    }
