...
Default mode is Python-stdlib only. --backend-root uses that checkout's existing
root .venv dependencies and temporary synthetic databases/media, never settings,
    ...
    with ExitStack() as guards:
        ...
        try:
            ...
            with tempfile.TemporaryDirectory(prefix='photohouse-contract-media-') as media:
                ...
                image=Image.new('RGB',(8,8),(160,180,140)); image.save(originals/'synthetic.jpg'); image.save(thumbs/'101.jpg')
